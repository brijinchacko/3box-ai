...
export const metadata: Metadata = generatePageMetadata({
  title: 'AI Resume Builder for Teachers | ATS-Optimized Education Resumes | 3BOX AI',
  description:
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLd({
            ...
            name: '3BOX AI Resume Builder for Teachers',
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLd(
            SCHEMA_ORG.breadcrumb([
              ...
              { name: 'Teacher', url: 'https://3box.ai/resume/teacher' },
            ])
          ),
        }}
      />

...
export const metadata: Metadata = generatePageMetadata({
  title: 'AI Resume Builder for Data Scientists | ML & Analytics Resumes | 3BOX AI',
  description:
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLd({
            ...
            name: '3BOX AI Resume Builder for Data Scientists',
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLd(
            SCHEMA_ORG.breadcrumb([
              ...
              { name: 'Data Scientist', url: 'https://3box.ai/resume/data-scientist' },
            ])
          ),
        }}
      />

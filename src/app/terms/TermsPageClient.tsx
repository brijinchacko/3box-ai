...
const sections = [
  {
    ...
    content: [
      { text: 'NXTED AI provides AI-powered career development tools including skill assessments, personalized career planning, resume building, portfolio creation, job matching, and interview preparation.' },
  ...
  },
  {
    ...
    content: [
      ...
      { text: 'NXTED AI provides career tools and does not guarantee employment outcomes.' },
  ...
  },
  {
    ...
    content: [
      ...
      { heading: 'Our platform', text: 'NXTED AI, OFORO AI, and all platform code, AI models, algorithms, and proprietary features are our intellectual property.' },
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-white/40 max-w-xl mx-auto mb-4">
              The rules and guidelines that govern your use of NXTED AI.
            </p>

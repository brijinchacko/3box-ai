...
const CONTENT_CALENDAR = [
  ...
  { title: '3BOX AI vs LinkedIn Career Explorer: Complete Comparison', targetKeyword: 'LinkedIn career explorer alternative', keywordDifficulty: 25, category: 'comparison', scheduledDate: new Date('2026-03-04') },
  ...
  { title: '3BOX AI vs Jobscan: Which ATS Tool Wins?', targetKeyword: 'Jobscan alternative', keywordDifficulty: 30, category: 'comparison', scheduledDate: new Date('2026-03-19') },
  // Week 4
  ...
  { title: '3BOX AI vs Careerflow: Feature-by-Feature Comparison', targetKeyword: 'Careerflow alternative', keywordDifficulty: 15, category: 'comparison', scheduledDate: new Date('2026-04-02') },
  ...
  { title: 'Video: How to Use 3BOX AI Career Twin Feature', targetKeyword: '3BOX AI tutorial', keywordDifficulty: 5, category: 'video', scheduledDate: new Date('2026-04-17') },
  // Month 2 - Week 8
  ...
  { title: '3BOX AI vs Teal HQ: Which Career Tool is Better?', targetKeyword: 'Teal HQ alternative', keywordDifficulty: 20, category: 'comparison', scheduledDate: new Date('2026-04-24') },
  // Month 3 - Week 9
  ...
  { title: '3BOX AI vs Kickresume: Resume Builder Comparison', targetKeyword: 'Kickresume alternative', keywordDifficulty: 22, category: 'comparison', scheduledDate: new Date('2026-05-15') },
  // Month 3 - Week 12

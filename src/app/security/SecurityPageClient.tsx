        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div id="terms" className="card mb-8 scroll-mt-24">
            ...
            <div className="space-y-4 text-sm text-white/50 leading-relaxed">
              ...
              <p>NXTED AI provides AI-powered career development tools including skill assessments, career planning, resume building, and job matching. The platform is provided &quot;as is&quot; and we continuously improve features.</p>
              ...
              <p>Ultra automation features apply to jobs on your behalf. You are responsible for reviewing automation settings and maintaining compliance with job platform terms. NXTED AI provides tools, not guarantees of employment.</p>

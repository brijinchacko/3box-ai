...
const pricingFaqs = [
  { question: 'Can I switch AI career plans anytime?', answer: 'Yes, you can upgrade or downgrade your jobTED AI plan at any time. Changes take effect immediately and billing is prorated.' },
  ...
  { question: 'What payment methods does jobTED AI accept?', answer: 'We accept all major credit cards, PayPal, and wire transfer for enterprise AI career platform plans.' },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLd(SCHEMA_ORG.breadcrumb([
            ...
            { name: 'Pricing', url: 'https://jobted.ai/pricing' },
          ])),
        }}
      />
      <PricingPageClient />

...
const pricingFaqs = [
  { question: 'Can I switch AI career plans anytime?', answer: 'Yes, you can upgrade or downgrade your 3BOX AI plan at any time. Changes take effect immediately and billing is prorated.' },
  ...
  { question: 'What payment methods does 3BOX AI accept?', answer: 'We accept all major credit cards, PayPal, and wire transfer for enterprise AI career platform plans.' },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLd(SCHEMA_ORG.breadcrumb([
            ...
            { name: 'Pricing', url: 'https://3box.ai/pricing' },
          ])),
        }}
      />
      <PricingPageClient />

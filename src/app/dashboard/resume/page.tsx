                  ...
                  {resume.experience.map((exp, i) => (
                    <div key={exp.id} className="p-4 rounded-lg border border-gray-200 dark:border-gray-700 space-y-3">
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        ...
                        <input placeholder="Start (e.g. 06.2021)" value={exp.startDate} onChange={(e) => { const updated = [...resume.experience]; updated[i] = { ...updated[i], startDate: e.target.value }; setResume(prev => ({ ...prev, experience: updated })); }} className="px-3 py-2 text-sm border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/20" />
                        <input placeholder="End (or Current)" value={exp.endDate} onChange={(e) => { const updated = [...resume.experience]; updated[i] = { ...updated[i], endDate: e.target.value }; setResume(prev => ({ ...prev, experience: updated })); }} className="px-3 py-2 text-sm border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/20" />
                      </div>

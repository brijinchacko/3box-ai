              ...
              <table className="w-full min-w-[600px]">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-white/5 bg-white/[0.02]">
                    ...
                    <td className="px-6 py-4 text-center border-x border-neon-blue/20 bg-neon-blue/[0.03]">
                      <span className="text-neon-green font-semibold">{data.nxtedPrice}</span>
                    </td>
                    <td className="px-6 py-4 text-center">
                  ...
                  <tr className="border-b border-white/5">
                    ...
                    <td className="px-6 py-4 text-center border-x border-neon-blue/20 bg-neon-blue/[0.03]">
                      <span className="text-neon-green text-sm">{data.nxtedFreeTier}</span>
                    </td>
                    <td className="px-6 py-4 text-center">
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 text-center border-x border-neon-blue/20 bg-neon-blue/[0.03]">
                      <div className="flex items-center justify-center gap-1">
                        ...
                        <span className="font-semibold">{data.nxtedRating}</span>
                        <span className="text-white/30 text-xs">({data.nxtedReviewCount})</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-center">
                      <div className="flex items-center justify-center gap-1">
      ...
      <section className="pb-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.h2
            ...
            className="text-2xl sm:text-3xl font-bold text-center mb-10"
          >
            Why Choose <span className="gradient-text">NXTED AI</span> Over{' '}
            {data.competitorName}
          </motion.h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">
              Ready to Switch to <span className="gradient-text">NXTED AI</span>?
            </h2>

...
export const AUTOMATION_MODES: Record<AutomationMode, AutomationModeDefinition> = {
  copilot: {
    ...
    name: 'Copilot',
    label: 'You Decide',
    description: 'You assign tasks to agents manually. Full control over every action.',
  ...
  autopilot: {
    ...
    name: 'Co-Pilot',
    label: 'Verify & Go',
    description: 'Agents work proactively but ask for your approval before every action.',
    icon: 'Zap',
  ...
  'full-agent': {
    ...
    description: 'Agents handle everything end-to-end. Search, apply, follow up — all on autopilot.',
    icon: 'BrainCircuit',

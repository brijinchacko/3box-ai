# 3BOX AI — Your AI Career Operating System

> An [OFORO AI](https://oforo.ai) Product

3BOX AI is a full-stack, AI-powered career platform that takes users from **skill assessment → personalized career plan → adaptive learning → resume + portfolio → verified credentials → job matching → automated applications**.
